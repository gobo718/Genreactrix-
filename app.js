const GENREACTRIX_BUILD="v0.9.3.11";
...
function cancelScheduledPrimFusionFit(root){
  // v0.9.3.11: fitting is intentionally disabled. PrimFusion labels use one
...
try{
  // v0.9.3.11 preserves the verified v0.9.2j storage namespace and clean classification namespace.
