const GENREACTRIX_BUILD="v0.9.2v";
...
try{
  // v0.9.2v preserves the verified v0.9.2j storage namespace and clean classification namespace.
...
// v0.9.2v: hydrate the active demo/image record from persistent storage only
