const GENREACTRIX_BUILD="v0.9.40.201";
// v0.9.40.201 — Clean restoration of v0.9.40.194 behavior with only the approved current PrimFusion taxonomy/matrix/definition changes carried forward.
