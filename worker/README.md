# Genreactrix AI Worker 0.9.6.157-safety-rerun
...
- Current bundled source matches standalone Worker v0.9.6.156 exactly, preserving Qwen gateway routing and adding only the non-fatal binary Content Gate sidecar after a completed Description.
- Companion site: v0.9.40.205-binary-content-gate-ai.
