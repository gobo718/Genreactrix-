/* Genreactrix AI Worker v0.9.6.97-targeted-theme-definition-calibration
...
*/
const API_VERSION = '0.9.6.97-targeted-theme-definition-calibration';
...
function validateRegistry(registry){
  if (!registry || registry.matrixVersion !== '0.0.0.1') throw new Error('Unexpected PrimFusion Matrix version');
...
// v0.9.6.97 — Targeted Theme-definition calibration: Obsessive, Grotesque, Brutal, Exposure, and Pride only. Inherits the .96 final-pass shuffle unchanged.
