/* Genreactrix AI Worker v0.9.6.133-smart-matrix-cache-repair
...
*/
const API_VERSION = '0.9.6.133-smart-matrix-cache-repair';
...
const PROMPT_DIAGNOSTIC_BATCH_COUNT = 5;
