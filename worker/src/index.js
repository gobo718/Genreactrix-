/* Genreactrix AI Worker v0.9.6.54-diagnostic-self-check-term-calibration
   Registry-driven replacement Worker.
   Source vocabulary is generated from primfusion-registry.json.
*/
const API_VERSION = '0.9.6.54-diagnostic-self-check-term-calibration';
